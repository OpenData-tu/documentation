\section{Extensible Data Import
...
Architecture}\label{framework-structure-architecture}

\textbf{Figure 1.} shows an abstract overview of a simple importer
application. We will look at each component individually.

\begin{figure}[htbp]
\centering
\includegraphics{images/components_diagram.png}
...
\includegraphics{images/domain_model.png} \textbf{Figure 2.} shows a
