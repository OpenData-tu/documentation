...
Project teams will always consist of heterogenous people with different skills
...
Concluding, a huge lesson that we learned is to start with a use case and then
